...
function App() {
  const [messages, setMessages] = useState([
    { role: 'agent', text: "Hello! I'm your personal assistant. I can help you find concerts, plan workouts, or answer general questions. How can I help you today?" }
  ]);
    ...
    const createSession = async () => {
      try {
        ...
        if (data && data.session_id) {
            ...
            console.warn("No session ID in response, using random UUID but this might fail.");
                ...
                try {
                    ...
                    if (newText) {
                         setMessages(prev => {
                            ...
                            if (newText.length > lastMsg.text.length && newText.startsWith(lastMsg.text)) {
    ...
    <div className="chat-container">
      ...
      <div className="input-area">
        ...
        <button 
            ...
            style={{ color: input.trim() ? 'var(--md-sys-color-primary)' : 'inherit' }}
        >
          <Send size={24} />
        </button>
      </div>
